...
Requires: vac,dhcp,tftp,tftp-server,syslinux-tftpboot,squid,ca-policy-egi-core,lcg-CA,xauth,tigervnc,ntp,yum-cron,apel-ssm,rpm-build,wget,docker,singularity,cvmfs
